...
class Rectangle: public Point                      
{
 ...
 //parameterized constructor
  //default constructor that builds a rectangle with coordinates (0,0), (0,1), (1,0), (1,1)
	public:
		Rectangle(Point,Point);          
		Rectangle();                    	
//member functions to calculate length of sides
	private:
		int side1();                      
		int side2();
 ...
 //variables to store length of sides
	public:
		int area();                      
		int l1,l2;                       
//function to access returned data from private member functions side1		
	int my_side1();                        
 //function to access returned data from private member functions side2	
	int my_side2();	                     		
};
// ********************************************************
...
Rectangle::Rectangle(Point a, Point b)
{
 ...
 //function definition of private member function side1()
int Rectangle::side1()                      
{
	l1 = p2.Get_Y() - p1.Get_Y();	
}
 //function definition of private member function side2()
int Rectangle::side2()                      
{
	l2 = p4.Get_X() - p1.Get_X();
}
//function definition of public member function area()
int Rectangle::area()						 
{
	return l1*l2;
}
...
//asks user the coordinates for 2 points using which a rectangle is to be made
   //variables for assigning coordinates to points p1 and p3
  int xval,yval;                                                   
